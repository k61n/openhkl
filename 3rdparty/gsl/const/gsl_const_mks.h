...
#define GSL_CONST_MKS_PLANCKS_CONSTANT_HBAR                                    \
...
#define GSL_CONST_MKS_STEFAN_BOLTZMANN_CONSTANT                                \
...
#define GSL_CONST_MKS_VACUUM_PERMITTIVITY                                      \
  (8.854187817e-12) /* A^2 s^4 / kg m^3 */
#define GSL_CONST_MKS_VACUUM_PERMEABILITY                                      \
