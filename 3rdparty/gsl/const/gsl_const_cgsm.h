...
#define GSL_CONST_CGSM_PLANCKS_CONSTANT_HBAR                                   \
  (1.05457162825e-27)                                       /* g cm^2 / s */
...
#define GSL_CONST_CGSM_STEFAN_BOLTZMANN_CONSTANT                               \
  (5.67040047374e-5) /* g / K^4 s^3 */
...
#define GSL_CONST_CGSM_ELECTRON_MAGNETIC_MOMENT                                \
  (9.28476362e-21) /* abamp cm^2 */
#define GSL_CONST_CGSM_PROTON_MAGNETIC_MOMENT                                  \
  (1.410606633e-23)                                      /* abamp cm^2         \
                                                          */
