...
#define GSL_CONST_MKSA_PLANCKS_CONSTANT_HBAR                                   \
  (1.05457162825e-34)                                       /* kg m^2 / s */
...
#define GSL_CONST_MKSA_STEFAN_BOLTZMANN_CONSTANT                               \
  (5.67040047374e-8) /* kg / K^4 s^3 */
...
#define GSL_CONST_MKSA_VACUUM_PERMITTIVITY                                     \
  (8.854187817e-12) /* A^2 s^4 / kg m^3 */
#define GSL_CONST_MKSA_VACUUM_PERMEABILITY                                     \
