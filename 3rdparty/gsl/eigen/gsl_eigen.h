...
int gsl_eigen_genv_QZ(gsl_matrix *A, gsl_matrix *B, gsl_vector_complex *alpha,
                      gsl_vector *beta, gsl_matrix_complex *evec, gsl_matrix *Q,
                      gsl_matrix *Z, gsl_eigen_genv_workspace *w);
 ...
 * exceptions:
 */
int gsl_eigen_jacobi(gsl_matrix *matrix, gsl_vector *eval, gsl_matrix *evec,
 ...
 * exceptions:
 */
int gsl_eigen_invert_jacobi(const gsl_matrix *matrix, gsl_matrix *ainv,
