 ...
 * exceptions:
 */
int gsl_sf_hyperg_1F1_int_e(const int m, const int n, const double x,
 ...
 * exceptions:
 */
int gsl_sf_hyperg_U_int_e(const int m, const int n, const double x,
                          gsl_sf_result *result);
 ...
 * exceptions:
 */
int gsl_sf_hyperg_U_int_e10_e(const int m, const int n, const double x,
 ...
 * exceptions:
 */
int gsl_sf_hyperg_U_e(const double a, const double b, const double x,
                      gsl_sf_result *result);
 ...
 * exceptions:
 */
int gsl_sf_hyperg_2F1_e(double a, double b, const double c, const double x,
                        gsl_sf_result *result);
 ...
 * exceptions:
 */
int gsl_sf_hyperg_2F1_conj_renorm_e(const double aR, const double aI,
 ...
 * exceptions: GSL_EDOM
 */
int gsl_sf_hyperg_2F0_e(const double a, const double b, const double x,
                        gsl_sf_result *result);
