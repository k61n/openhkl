...
/* cblas_xgemm() */
#define CBLAS_ERROR_GEMM(pos, Order, TransA, TransB, M, N, K, alpha, A, lda,   \
                         B, ldb, beta, C, ldc)                                 \
  {                                                                            \
...
/* cblas_xsymm() */
#define CBLAS_ERROR_SYMM(pos, Order, Side, Uplo, M, N, alpha, A, lda, B, ldb,  \
                         beta, C, ldc)                                         \
  {                                                                            \
    int __dimA = 0;                                                            \
    if ((Side) == CblasLeft) {                                                 \
...
/* cblas_xsyrk() */
#define CBLAS_ERROR_SYRK(pos, Order, Uplo, Trans, N, K, alpha, A, lda, beta,   \
                         C, ldc)                                               \
  {                                                                            \
    int __dimA = 0;                                                            \
    if ((Order) == CblasRowMajor) {                                            \
...
/* cblas_xsyr2k() */
#define CBLAS_ERROR_SYR2K(pos, Order, Uplo, Trans, N, K, alpha, A, lda, B,     \
                          ldb, beta, C, ldc)                                   \
  {                                                                            \
    int __dim = 0;                                                             \
    if ((Order) == CblasRowMajor) {                                            \
...
/* cblas_xtrmm() */
#define CBLAS_ERROR_TRMM(pos, Order, Side, Uplo, TransA, Diag, M, N, alpha, A, \
                         lda, B, ldb)                                          \
  {                                                                            \
    int __dim = 0;                                                             \
    if ((Side) == CblasLeft) {                                                 \
...
/* cblas_xtrsm() */
#define CBLAS_ERROR_TRSM(pos, Order, Side, Uplo, TransA, Diag, M, N, alpha, A, \
                         lda, B, ldb)                                          \
  CBLAS_ERROR_TRMM(pos, Order, Side, Uplo, TransA, Diag, M, N, alpha, A, lda,  \
                   B, ldb)
...
/* cblas_xhemm() */
#define CBLAS_ERROR_HEMM(pos, Order, Side, Uplo, M, N, alpha, A, lda, B, ldb,  \
                         beta, C, ldc)                                         \
  CBLAS_ERROR_SYMM(pos, Order, Side, Uplo, M, N, alpha, A, lda, B, ldb, beta,  \
                   C, ldc)

/* cblas_xherk() */
#define CBLAS_ERROR_HERK(pos, Order, Uplo, Trans, N, K, alpha, A, lda, beta,   \
                         C, ldc)                                               \
  CBLAS_ERROR_SYRK(pos, Order, Uplo, Trans, N, K, alpha, A, lda, beta, C, ldc)

/* cblas_xher2k() */
#define CBLAS_ERROR_HER2K(pos, Order, Uplo, Trans, N, K, alpha, A, lda, B,     \
                          ldb, beta, C, ldc)                                   \
  CBLAS_ERROR_SYR2K(pos, Order, Uplo, Trans, N, K, alpha, A, lda, B, ldb,      \
                    beta, C, ldc)
