      ...
      for (i = 0; i < n1; i++) {
        for (j = 0; j < n2; j++) {
          ...
          BASE temp2_imag = 0.0;
          {
            ...
            REAL(C, i * ldc + j) +=
                temp1_real * Ajj_real - temp1_imag * Ajj_imag;
            IMAG(C, i * ldc + j) +=
                temp1_real * Ajj_imag + temp1_imag * Ajj_real;
          }
          for (k = j + 1; k < n2; k++) {
            ...
            REAL(C, i * ldc + k) +=
                temp1_real * Ajk_real - temp1_imag * Ajk_imag;
            IMAG(C, i * ldc + k) +=
                temp1_real * Ajk_imag + temp1_imag * Ajk_real;
