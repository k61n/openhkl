 ...
 *
 * Copyright (C) 1996, 1997, 1998, 1999, 2000, 2004, 2007 Jorma Olavi Tähtinen,
 * Brian Gough
 *
...
INLINE_DECL gsl_complex gsl_complex_rect(double x,
                                         double y); /* r= real+i*imag */

#ifdef HAVE_INLINE
INLINE_FUN gsl_complex gsl_complex_rect(double x,
