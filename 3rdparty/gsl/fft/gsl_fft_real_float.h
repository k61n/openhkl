...
int gsl_fft_real_float_radix2_transform(float data[], const size_t stride,
                                        const size_t n);
...
int gsl_fft_real_float_transform(float data[], const size_t stride,
                                 const size_t n,
...
int gsl_fft_real_float_unpack(const float real_float_coefficient[],
                              float complex_coefficient[], const size_t stride,
                              const size_t n);
