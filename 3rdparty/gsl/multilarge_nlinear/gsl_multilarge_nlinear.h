...
typedef struct {
  ...
  int (*step)(const void *vtrust_state, const double delta, gsl_vector *dx,
              void *vstate);
...
typedef struct {
  ...
  int (*solve)(const gsl_vector *g, gsl_vector *x, const void *vtrust_state,
               void *vstate);
...
typedef struct {
  ...
  int (*iterate)(void *state, const gsl_vector *wts,
                 gsl_multilarge_nlinear_fdf *fdf, gsl_vector *x, gsl_vector *f,
...
int gsl_multilarge_nlinear_winit(const gsl_vector *x, const gsl_vector *wts,
                                 gsl_multilarge_nlinear_fdf *fdf,
                                 gsl_multilarge_nlinear_workspace *w);
...
int gsl_multilarge_nlinear_rcond(double *rcond,
                                 const gsl_multilarge_nlinear_workspace *w);

int gsl_multilarge_nlinear_covar(gsl_matrix *covar,
                                 gsl_multilarge_nlinear_workspace *w);

int gsl_multilarge_nlinear_driver(
    const size_t maxiter, const double xtol, const double gtol,
    const double ftol,
    void (*callback)(const size_t iter, void *params,
                     const gsl_multilarge_nlinear_workspace *w),
    void *callback_params, int *info, gsl_multilarge_nlinear_workspace *w);
...
int gsl_multilarge_nlinear_eval_f(gsl_multilarge_nlinear_fdf *fdf,
                                  const gsl_vector *x, const gsl_vector *swts,
                                  gsl_vector *y);

int gsl_multilarge_nlinear_eval_df(
    const CBLAS_TRANSPOSE_t TransJ, const gsl_vector *x, const gsl_vector *f,
    const gsl_vector *u, const gsl_vector *swts, const double h,
    const gsl_multilarge_nlinear_fdtype fdtype, gsl_multilarge_nlinear_fdf *fdf,
    gsl_vector *v, gsl_matrix *JTJ, gsl_vector *work);

int gsl_multilarge_nlinear_eval_fvv(const double h, const gsl_vector *x,
                                    const gsl_vector *v, const gsl_vector *f,
...
/*
int
gsl_multilarge_nlinear_df(const double h, const gsl_multilarge_nlinear_fdtype
fdtype, const gsl_vector *x, const gsl_vector *wts, gsl_multilarge_nlinear_fdf
*fdf, const gsl_vector *f, gsl_matrix *J, gsl_vector *work);
                                                  */

/* fdfvv.c */
/*
int
gsl_multilarge_nlinear_fdfvv(const double h, const gsl_vector *x, const
gsl_vector *v, const gsl_vector *f, const gsl_matrix *J, const gsl_vector *swts,
gsl_multilarge_nlinear_fdf *fdf, gsl_vector *fvv, gsl_vector *work);
                                                         */
...
GSL_VAR const gsl_multilarge_nlinear_scale
...
/* linear solvers */
GSL_VAR const gsl_multilarge_nlinear_solver
