...
INLINE_FUN unsigned long int gsl_rng_get(const gsl_rng *r) {
  return (r->type->get)(r->state);
}

INLINE_FUN double gsl_rng_uniform(const gsl_rng *r) {
  return (r->type->get_double)(r->state);
}

INLINE_FUN double gsl_rng_uniform_pos(const gsl_rng *r) {
  double x;
  do {
...
INLINE_FUN unsigned long int gsl_rng_uniform_int(const gsl_rng *r,
                                                 unsigned long int n) {
