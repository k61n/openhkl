...
int brownscal_fdf(const gsl_vector *x, void *params, gsl_vector *f,
                  gsl_matrix *df);
...
int powellscal_fdf(const gsl_vector *x, void *params, gsl_vector *f,
                   gsl_matrix *df);
...
int powellsing_fdf(const gsl_vector *x, void *params, gsl_vector *f,
                   gsl_matrix *df);
...
int helical_fdf(const gsl_vector *x, void *params, gsl_vector *f,
                gsl_matrix *df);
