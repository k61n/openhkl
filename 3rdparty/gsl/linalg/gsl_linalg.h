/* linalg/gsl_linalg.h
 *
 * Copyright (C) 1996, 1997, 1998, 1999, 2000, 2006, 2007 Gerard Jungman, Brian
 * Gough, Patrick Alken
 *
 ...
 */
int gsl_linalg_exponential_ss(const gsl_matrix *A, gsl_matrix *eA,
                              gsl_mode_t mode);
...
int gsl_linalg_SV_solve(const gsl_matrix *U, const gsl_matrix *Q,
...
int gsl_linalg_QR_svx(const gsl_matrix *QR, const gsl_vector *tau,
                      gsl_vector *x);
...
int gsl_linalg_QR_Rsolve(const gsl_matrix *QR, const gsl_vector *b,
                         gsl_vector *x);

int gsl_linalg_QR_Rsvx(const gsl_matrix *QR, gsl_vector *x);

int gsl_linalg_QR_update(gsl_matrix *Q, gsl_matrix *R, gsl_vector *w,
                         const gsl_vector *v);

int gsl_linalg_QR_QTvec(const gsl_matrix *QR, const gsl_vector *tau,
                        gsl_vector *v);

int gsl_linalg_QR_Qvec(const gsl_matrix *QR, const gsl_vector *tau,
                       gsl_vector *v);

int gsl_linalg_QR_QTmat(const gsl_matrix *QR, const gsl_vector *tau,
                        gsl_matrix *A);

int gsl_linalg_QR_matQ(const gsl_matrix *QR, const gsl_vector *tau,
                       gsl_matrix *A);
...
int gsl_linalg_QRPT_decomp(gsl_matrix *A, gsl_vector *tau, gsl_permutation *p,
                           int *signum, gsl_vector *norm);

int gsl_linalg_QRPT_decomp2(const gsl_matrix *A, gsl_matrix *q, gsl_matrix *r,
                            gsl_vector *tau, gsl_permutation *p, int *signum,
                            gsl_vector *norm);

int gsl_linalg_QRPT_solve(const gsl_matrix *QR, const gsl_vector *tau,
                          const gsl_permutation *p, const gsl_vector *b,
                          gsl_vector *x);

int gsl_linalg_QRPT_lssolve(const gsl_matrix *QR, const gsl_vector *tau,
                            const gsl_permutation *p, const gsl_vector *b,
                            gsl_vector *x, gsl_vector *residual);

int gsl_linalg_QRPT_lssolve2(const gsl_matrix *QR, const gsl_vector *tau,
                             const gsl_permutation *p, const gsl_vector *b,
                             const size_t rank, gsl_vector *x,
                             gsl_vector *residual);

int gsl_linalg_QRPT_svx(const gsl_matrix *QR, const gsl_vector *tau,
...
int gsl_linalg_QRPT_update(gsl_matrix *Q, gsl_matrix *R,
                           const gsl_permutation *p, gsl_vector *u,
                           const gsl_vector *v);

size_t gsl_linalg_QRPT_rank(const gsl_matrix *QR, const double tol);

int gsl_linalg_QRPT_rcond(const gsl_matrix *QR, double *rcond,
                          gsl_vector *work);
...
int gsl_linalg_COD_decomp_e(gsl_matrix *A, gsl_vector *tau_Q, gsl_vector *tau_Z,
                            gsl_permutation *p, double tol, size_t *rank,
                            gsl_vector *work);

int gsl_linalg_COD_lssolve(const gsl_matrix *QRZ, const gsl_vector *tau_Q,
                           const gsl_vector *tau_Z, const gsl_permutation *perm,
                           const size_t rank, const gsl_vector *b,
                           gsl_vector *x, gsl_vector *residual);

int gsl_linalg_COD_unpack(const gsl_matrix *QRZ, const gsl_vector *tau_Q,
                          const gsl_vector *tau_Z, const size_t rank,
                          gsl_matrix *Q, gsl_matrix *R, gsl_matrix *Z);

int gsl_linalg_COD_matZ(const gsl_matrix *QRZ, const gsl_vector *tau_Z,
                        const size_t rank, gsl_matrix *A, gsl_vector *work);
...
int gsl_linalg_LQ_update(gsl_matrix *Q, gsl_matrix *R, const gsl_vector *v,
                         gsl_vector *w);
int gsl_linalg_LQ_LQsolve(gsl_matrix *Q, gsl_matrix *L, const gsl_vector *b,
                          gsl_vector *x);

/* P^T L Q decomposition */

int gsl_linalg_PTLQ_decomp(gsl_matrix *A, gsl_vector *tau, gsl_permutation *p,
                           int *signum, gsl_vector *norm);

int gsl_linalg_PTLQ_decomp2(const gsl_matrix *A, gsl_matrix *q, gsl_matrix *r,
                            gsl_vector *tau, gsl_permutation *p, int *signum,
                            gsl_vector *norm);
...
int gsl_linalg_PTLQ_svx_T(const gsl_matrix *LQ, const gsl_vector *tau,
                          const gsl_permutation *p, gsl_vector *x);
...
int gsl_linalg_PTLQ_Lsolve_T(const gsl_matrix *LQ, const gsl_permutation *p,
                             const gsl_vector *b, gsl_vector *x);

int gsl_linalg_PTLQ_Lsvx_T(const gsl_matrix *LQ, const gsl_permutation *p,
                           gsl_vector *x);

int gsl_linalg_PTLQ_update(gsl_matrix *Q, gsl_matrix *L,
                           const gsl_permutation *p, const gsl_vector *v,
                           gsl_vector *w);
...
int gsl_linalg_cholesky_solve(const gsl_matrix *cholesky, const gsl_vector *b,
                              gsl_vector *x);
...
int gsl_linalg_cholesky_svx2(const gsl_matrix *LLT, const gsl_vector *S,
                             gsl_vector *x);

int gsl_linalg_cholesky_solve2(const gsl_matrix *LLT, const gsl_vector *S,
                               const gsl_vector *b, gsl_vector *x);
...
int gsl_linalg_pcholesky_solve(const gsl_matrix *LDLT, const gsl_permutation *p,
                               const gsl_vector *b, gsl_vector *x);

int gsl_linalg_pcholesky_svx(const gsl_matrix *LDLT, const gsl_permutation *p,
                             gsl_vector *x);
...
int gsl_linalg_pcholesky_solve2(const gsl_matrix *LDLT,
                                const gsl_permutation *p, const gsl_vector *S,
                                const gsl_vector *b, gsl_vector *x);

int gsl_linalg_pcholesky_svx2(const gsl_matrix *LDLT, const gsl_permutation *p,
                              const gsl_vector *S, gsl_vector *x);

int gsl_linalg_pcholesky_invert(const gsl_matrix *LDLT,
...
int gsl_linalg_mcholesky_solve(const gsl_matrix *LDLT, const gsl_permutation *p,
                               const gsl_vector *b, gsl_vector *x);

int gsl_linalg_mcholesky_svx(const gsl_matrix *LDLT, const gsl_permutation *p,
                             gsl_vector *x);

int gsl_linalg_mcholesky_rcond(const gsl_matrix *LDLT, const gsl_permutation *p,
                               double *rcond, gsl_vector *work);

int gsl_linalg_mcholesky_invert(const gsl_matrix *LDLT,
                                const gsl_permutation *p, gsl_matrix *Ainv);
...
int gsl_linalg_symmtd_unpack(const gsl_matrix *A, const gsl_vector *tau,
                             gsl_matrix *Q, gsl_vector *diag,
                             gsl_vector *subdiag);

int gsl_linalg_symmtd_unpack_T(const gsl_matrix *A, gsl_vector *diag,
                               gsl_vector *subdiag);
...
int gsl_linalg_hermtd_unpack(const gsl_matrix_complex *A,
                             ...
                             gsl_matrix_complex *U, gsl_vector *diag,
                             gsl_vector *sudiag);

int gsl_linalg_hermtd_unpack_T(const gsl_matrix_complex *A, gsl_vector *diag,
                               gsl_vector *subdiag);
...
int gsl_linalg_solve_tridiag(const gsl_vector *diag,
                             ...
                             const gsl_vector *belowdiag, const gsl_vector *b,
                             gsl_vector *x);
...
int gsl_linalg_bidiag_decomp(gsl_matrix *A, gsl_vector *tau_U,
                             gsl_vector *tau_V);
...
int gsl_linalg_bidiag_unpack2(gsl_matrix *A, gsl_vector *tau_U,
                              gsl_vector *tau_V, gsl_matrix *V);

int gsl_linalg_bidiag_unpack_B(const gsl_matrix *A, gsl_vector *diag,
                               gsl_vector *superdiag);
...
int gsl_linalg_tri_upper_rcond(const gsl_matrix *A, double *rcond,
                               gsl_vector *work);
int gsl_linalg_tri_lower_rcond(const gsl_matrix *A, double *rcond,
                               gsl_vector *work);
int gsl_linalg_invnorm1(const size_t N,
                        int (*Ainvx)(CBLAS_TRANSPOSE_t TransA, gsl_vector *x,
                                     void *params),
...
INLINE_DECL void gsl_linalg_givens(const double a, const double b, double *c,
                                   double *s);
...
INLINE_FUN
void gsl_linalg_givens_gv(gsl_vector *v, const size_t i, const size_t j,
