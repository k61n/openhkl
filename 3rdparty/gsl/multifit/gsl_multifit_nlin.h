...
int gsl_multifit_covar(const gsl_matrix *J, const double epsrel,
                       gsl_matrix *covar);
...
typedef struct {
  ...
  int (*set)(void *state, gsl_multifit_function *function, gsl_vector *x,
             gsl_vector *f, gsl_vector *dx);
  int (*iterate)(void *state, gsl_multifit_function *function, gsl_vector *x,
                 gsl_vector *f, gsl_vector *dx);
...
gsl_multifit_fsolver *
gsl_multifit_fsolver_alloc(const gsl_multifit_fsolver_type *T, size_t n,
                           size_t p);
...
typedef struct {
  ...
  size_t size;
  int (*alloc)(void *state, size_t n, size_t p);
  int (*set)(void *state, const gsl_vector *wts, gsl_multifit_function_fdf *fdf,
             gsl_vector *x, gsl_vector *f, gsl_vector *dx);
  int (*iterate)(void *state, const gsl_vector *wts,
                 gsl_multifit_function_fdf *fdf, gsl_vector *x, gsl_vector *f,
                 gsl_vector *dx);
...
gsl_multifit_fdfsolver *
gsl_multifit_fdfsolver_alloc(const gsl_multifit_fdfsolver_type *T, size_t n,
                             size_t p);
...
int gsl_multifit_fdfridge_set(gsl_multifit_fdfridge *w,
                              gsl_multifit_function_fdf *f, const gsl_vector *x,
                              const double lambda);
int gsl_multifit_fdfridge_wset(gsl_multifit_fdfridge *w,
                               gsl_multifit_function_fdf *f,
                               const gsl_vector *x, const double lambda,
                               const gsl_vector *wts);
int gsl_multifit_fdfridge_set2(gsl_multifit_fdfridge *w,
                               gsl_multifit_function_fdf *f,
                               const gsl_vector *x, const gsl_vector *lambda);
...
int gsl_multifit_fdfridge_set3(gsl_multifit_fdfridge *w,
                               gsl_multifit_function_fdf *f,
                               const gsl_vector *x, const gsl_matrix *L);
