...
#define GSL_ODEIV_JA_EVAL(S, t, y, dfdy, dfdt)                                 \
  (*((S)->jacobian))(t, y, dfdy, dfdt, (S)->params)
...
int gsl_odeiv_step_apply(gsl_odeiv_step *s, double t, double h, double y[],
...
int gsl_odeiv_control_init(gsl_odeiv_control *c, double eps_abs, double eps_rel,
                           double a_y, double a_dydt);
void gsl_odeiv_control_free(gsl_odeiv_control *c);
int gsl_odeiv_control_hadjust(gsl_odeiv_control *c, gsl_odeiv_step *s,
...
gsl_odeiv_control *gsl_odeiv_control_standard_new(double eps_abs,
 ...
 */
gsl_odeiv_control *gsl_odeiv_control_scaled_new(double eps_abs, double eps_rel,
                                                double a_y, double a_dydt,
...
int gsl_odeiv_evolve_apply(gsl_odeiv_evolve *e, gsl_odeiv_control *con,
                           gsl_odeiv_step *step, const gsl_odeiv_system *dydt,
