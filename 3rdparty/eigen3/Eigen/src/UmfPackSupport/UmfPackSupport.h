...
protected:
  ...
  void analyzePattern_impl() {
    ...
    errorCode = umfpack_symbolic(
        ...
        mp_matrix.valuePtr(), &m_symbolic, m_control.data(), 0);
  ...
  void factorize_impl() {
    m_fact_errorCode = umfpack_numeric(
        mp_matrix.outerIndexPtr(), mp_matrix.innerIndexPtr(),
        mp_matrix.valuePtr(), m_symbolic, &m_numeric, m_control.data(), 0);
