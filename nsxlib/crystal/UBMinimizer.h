...
struct UBFunctor : public Utils::LMFunctor<double> {
     ...
     */
    void setDetector(const std::shared_ptr<nsx::Instrument::Detector>& detector);
    /*
     * @brief Set the sample related to the peaks collected for the minimization
     * @param sample the sample
     */
    void setSample(const std::shared_ptr<nsx::Instrument::Sample>& sample);
    //! Set the source
    ...
    std::shared_ptr<nsx::Instrument::Detector> _detector;
    std::shared_ptr<nsx::Instrument::Sample> _sample;
...
struct UBSolution {
    ...
    UBSolution(std::shared_ptr<nsx::Instrument::Detector> detector,
