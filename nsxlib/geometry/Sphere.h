...
template<typename T,SX::Types::uint D> bool collideSphereAABB(const Sphere<T,D>&, const AABB<T,D>&);
template<typename T,SX::Types::uint D> bool collideSphereEllipsoid(const Sphere<T,D>&, const Ellipsoid<T,D>&);
template<typename T,SX::Types::uint D> bool collideSphereOBB(const Sphere<T,D>&, const OBB<T,D>&);
