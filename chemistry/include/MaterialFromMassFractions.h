...
#ifndef NSXTOOL_MATERIALFROMMASSFRACTIONS_H_
#define NSXTOOL_MATERIALFROMMASSFRACTIONS_H_
...
class MaterialFromMassFractions : public IMaterial
{
...
public:
	...
	void addElement(sptrElement element, double massFraction);
	//! Add a shared pointer to a Material object to this Material
	void addMaterial(sptrMaterial material, double massFraction);
...
private:
	...
	MaterialFromMassFractions(const std::string& name);

	//! Constructs an empty Material with a given name and chemical state
	MaterialFromMassFractions(const std::string& name, ChemicalState state);

	//! Constructs an empty Material with a given name and chemical state in its string version
	MaterialFromMassFractions(const std::string& name, const std::string& strState);

	//! Default constructor (deleted)
	MaterialFromMassFractions()=delete;

	//! Copy constructor (deleted)
	MaterialFromMassFractions(const MaterialFromMassFractions& other)=delete;

	//! Assignment operator (deleted)
	MaterialFromMassFractions& operator=(const MaterialFromMassFractions& other)=delete;
};
...
#endif /* NSXTOOL_MATERIALFROMMASSFRACTIONS_H_ */
