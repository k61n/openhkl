...
void reduceSymbol(std::string& symbol)
{
    ...
    if (symbol == "P 1" || symbol == "P 3 1 m" || symbol == "P 3 m 1" || symbol == "P -3 1 m"
        || symbol == "P -3 m 1" || symbol == "P 3 1 c" || symbol == "P 3 c 1"
        || symbol == "P -3 1 c" || symbol == "P -3 c 1" || symbol == "P 32 2 1"
        || symbol == "P 32 1 2" || symbol == "P 31 1 2" || symbol == "P 31 2 1"
        || symbol == "P 3 1 2" || symbol == "P 3 2 1")
        return;
