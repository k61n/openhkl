...
\begin{align}
  ...
  &= \bu K\sqrt{1+ 2\frac{\k_\si \cdot \delta \k_\si}{\k_\si^2}} \\
  &\approx \bu K \left(1 +  \frac{\k_\si \cdot \delta \k_\si}{\k_\si^2}\right) \\
  &= \k_\sf + \delta \k_\sf,
\end{align}
...
\begin{equation}
  ...
  =: A \delta \k_\si,
\end{equation}
where $A$ is the matrix $A = K^{-1} \bu \k_\si^t - \v1 = K^{-2} \k_\sf \k_\si^t - \v1$. Note that $A \k_\si = \q$ and therefore
...
where $R$ is the rotation matrix from lab space to sample space and $A = K^{-2} \k_\sf \k_\si^t - \v1$.
