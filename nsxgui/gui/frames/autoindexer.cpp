...
void AutoIndexer::layout()
{
    ...
    model = new PeaksTableModel("adhoc_autoIndexerPeakTable",
    ...
    //connections
    connect(tabs->tabBar(), &QTabBar::tabBarDoubleClicked, this,
            &AutoIndexer::slotTabEdited);
    connect(tabs, &QcrTabWidget::tabCloseRequested, this,
            &AutoIndexer::slotTabRemoved);
    connect(solutions->verticalHeader(), &QHeaderView::sectionDoubleClicked,
            this, &AutoIndexer::selectSolution);
    connect(buttons, &QDialogButtonBox::clicked, this,
            &AutoIndexer::slotActionClicked);
