...
void Refiner::layout()
{
    ...
    PeaksTableModel* model = new PeaksTableModel("adhoc_refinerPeaks",
    ...
    refine_lattice = new QcrCheckBox("adhoc_refineLattice", "lattice parameters (UB)",
                                     new QcrCell<bool>(true));
    refine_samplePosition = new QcrCheckBox("adhoc_refineSamplePosition",
                                            "Sample position", new QcrCell<bool>(true));
    refine_detectorPosition = new QcrCheckBox("adhoc_refineDetectorPosition", "Detector position",
                                              new QcrCell<bool>(false));
    refine_sampleOrientation = new QcrCheckBox("adhoc_refineSampleOrientation",
                                               "Sample orientation", new QcrCell<bool>(true));
...
void Refiner::tabRemoved(int index)
{
    auto refiner_fit_tab =
        dynamic_cast<RefinerFitWidget *>(tabs->widget(index));
    if (!refiner_fit_tab) {
      return;
    }
...
void Refiner::refine()
{
    ...
    for (auto d : data) {
      ...
      gLogger->log("[INFO] "+QString::number(reference_peaks.size()) + " splitted into " +
      ...
      if (success) {
        gLogger->log("[INFO] Successfully refined parameters for numor "
        ...
        gLogger->log("[INFO] Failed to refine parameters for numor "
                       + QString::fromStdString(d->filename()));
      }
    }
    ...
    QModelIndex bottomRight =
        peaks_model->index(peaks_model->rowCount() - 1,
                           peaks_model->columnCount() - 1);
...
RefinerFitWidget::RefinerFitWidget(const std::map<nsx::sptrDataSet, nsx::Refiner> &refiners)
    : QcrWidget{"adhoc_refinerWidgetTab"}
    , _refiners{refiners}
{
    layout();
    ...
    connect(selectedData, &QListWidget::currentRowChanged, this,
            &RefinerFitWidget::selectedDataChanged);

    connect(batch, static_cast<void(QSpinBox::*)(int)>(&QSpinBox::valueChanged), this,
            &RefinerFitWidget::selectedBatchChanged);

    connect(frame, static_cast<void(QSpinBox::*)(int)>(&QSpinBox::valueChanged), this,
...
void RefinerFitWidget::layout()
{
    ...
    samplePosX = new QcrDoubleSpinBox("adhoc_refinedSamplePosX", new QcrCell<double>(0.0),
                                      10, 6);
    samplePosY = new QcrDoubleSpinBox("adhoc_refinedSamplePosY", new QcrCell<double>(0.0),
                                      10, 6);
    samplePosZ = new QcrDoubleSpinBox("adhoc_refinedSamplePosZ", new QcrCell<double>(0.0),
                                      10, 6);
    ...
    detectorPosX = new QcrDoubleSpinBox("adhoc_refinedDetectorPosX", new QcrCell<double>(0.0),
                                        10, 6);
    detectorPosY = new QcrDoubleSpinBox("adhoc_refinedDetectorPosY", new QcrCell<double>(0.0),
                                        10, 6);
    detectorPosZ = new QcrDoubleSpinBox("adhoc_refinedDetectorPosZ", new QcrCell<double>(0.0),
                                        10, 6);
    ...
    wavelengthOffset = new QcrDoubleSpinBox("adhoc_refinedwavelengthOffset",
                                            new QcrCell<double>(0.0), 10, 6);
    ...
    sampleOrientation00 = new QcrDoubleSpinBox("adhoc_refinedSampleOri00",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation01 = new QcrDoubleSpinBox("adhoc_refinedSampleOri01",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation02 = new QcrDoubleSpinBox("adhoc_refinedSampleOri02",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation10 = new QcrDoubleSpinBox("adhoc_refinedSampleOri10",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation11 = new QcrDoubleSpinBox("adhoc_refinedSampleOri11",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation12 = new QcrDoubleSpinBox("adhoc_refinedSampleOri12",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation20 = new QcrDoubleSpinBox("adhoc_refinedSampleOri20",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation21 = new QcrDoubleSpinBox("adhoc_refinedSampleOri21",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    sampleOrientation22 = new QcrDoubleSpinBox("adhoc_refinedSampleOri22",
                                               new QcrCell<double>(0.0),
                                               10, 6);
    ...
    detectorOrientation00 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri00",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation01 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri01",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation02 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri02",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation10 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri10",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation11 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri11",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation12 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri12",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation20 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri20",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation21 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri21",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
    detectorOrientation22 = new QcrDoubleSpinBox("adhoc_refinedDetectorOri22",
                                                 new QcrCell<double>(0.0),
                                                 10, 6);
...
//    _ui->refined->setText(selected_state.refined ? "Refined" : "Not refined");
    ...
    Eigen::Matrix3d sample_orientation_matrix =
        selected_state.sampleOrientationMatrix();
    ...
    detectorOrientation00->setCellValue(
        selected_state.detectorOrientation(0, 0));
    detectorOrientation01->setCellValue(
        selected_state.detectorOrientation(0, 1));
    detectorOrientation02->setCellValue(
        selected_state.detectorOrientation(0, 2));
    detectorOrientation10->setCellValue(
        selected_state.detectorOrientation(1, 0));
    detectorOrientation11->setCellValue(
        selected_state.detectorOrientation(1, 1));
    detectorOrientation12->setCellValue(
        selected_state.detectorOrientation(1, 2));
    detectorOrientation20->setCellValue(
        selected_state.detectorOrientation(2, 0));
    detectorOrientation21->setCellValue(
        selected_state.detectorOrientation(2, 1));
    detectorOrientation22->setCellValue(
        selected_state.detectorOrientation(2, 2));
}
