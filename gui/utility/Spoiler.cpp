...
Spoiler::Spoiler(const QString & title, const int animationDuration, QWidget *parent) : QGroupBox(parent), animationDuration(animationDuration) {
    ...
    QObject::connect(
        &toggleButton, SIGNAL(clicked(bool)), 
        this, SLOT(toggler(bool)));
}
