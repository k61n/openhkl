...
void SubframeExperiment::importMasks()
{
    ...
    try {
        ...
        QMessageBox::critical(nullptr, "Error", QString("Failed to open or parse selected file: ") + e.what());
    }
}
...
void SubframeExperiment::setPeakFinder2DUp()
{
    ...
    connect(
        ...
        &SubframeExperiment::showFilteredImage);
    connect(_r1, &QDoubleSpinBox::editingFinished, [this]() {
        ...
        if (r1Value > r3Value) {
            _r3->setValue(r1Value);
        }
    });
    connect(_r2, &QDoubleSpinBox::editingFinished, [this]() {
        double r1Value = _r1->value();
        double r2Value = _r2->value();
        double r3Value = _r3->value();
        if (r2Value < r1Value) {
    ...
    connect(_r3, &QDoubleSpinBox::editingFinished, [this]() {
        double r1Value = _r1->value();
        double r2Value = _r2->value();
        double r3Value = _r3->value();
        if (r3Value < r2Value) {
