...
{
	Eigen::Matrix3d mat1;
	mat1(0,0) = 1.0000; mat1(0,1) = 0.0000; mat1(0,2) =  0.0000;
	mat1(1,0) = 0.0000; mat1(1,1) = 0.7071; mat1(1,2) = -0.7071;
	mat1(2,0) = 0.0000; mat1(2,1) = 0.7071; mat1(2,2) =  0.7071;

	Eigen::Matrix3d mat2;
	mat2(0,0) =  0.4067; mat2(0,1) = 0.0000; mat2(0,2) = 0.9136;
	mat2(1,0) =  0.0000; mat2(1,1) = 1.0000; mat2(1,2) = 0.0000;
	mat2(2,0) = -0.9136; mat2(2,1) = 0.0000; mat2(2,2) = 0.4067;
