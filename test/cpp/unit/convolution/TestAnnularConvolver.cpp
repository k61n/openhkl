...
//
//! @file      test/cpp/data/TestAnnularConvolver.cpp
//! @brief     Test ...
//!
...
TEST_CASE("test/data/TestAnnularConvolver.cpp", "")
{
    ...
    ohkl::AnnularConvolver convolver(convolver_params);
    ...
    CHECK(maxval == Approx(470.2096695821).epsilon(eps));
    CHECK(minval == Approx(-137.1073858115).epsilon(eps));
    ...
    cv::imwrite("annular.jpg", cv_image_8u);
