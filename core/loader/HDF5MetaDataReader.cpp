...
template <> std::string HDF5MetaDataReader<LegacyReader>::_metaKey(const std::string&) const
{
    return "Experiment";
}

template <> std::string HDF5MetaDataReader<LegacyReader>::_infoKey(const std::string&) const
{
    return "Info";
}

template <> std::string HDF5MetaDataReader<LegacyReader>::_detectorKey(const std::string&) const
{
    return "Data/Scan/Detector";
}

template <> std::string HDF5MetaDataReader<LegacyReader>::_sampleKey(const std::string&) const
{
    return "Data/Scan/Sample";
}

template <> std::string HDF5MetaDataReader<LegacyReader>::_dataKey(const std::string&) const
{
    return "Data/Counts";
}
