...
Triangle::Triangle(const Eigen::Vector3d &a, const Eigen::Vector3d &b,
...
void Triangle::calculate() {
  ...
  _d = -(_A[0] * _B[1] * _C[2] + _A[1] * _B[2] * _C[0] + _A[2] * _B[0] * _C[1] -
         _C[0] * _B[1] * _A[2] - _A[0] * _C[1] * _B[2] - _B[0] * _A[1] * _C[2]);
...
bool Triangle::rayIntersect(const Eigen::Vector3d &point,
                            const Eigen::Vector3d &dir, double &t1) const {
