...
const Eigen::RowVector3i &MillerIndex::rowVector() const { return _hkl; }
...
void MillerIndex::print(std::ostream &os) const { os << _hkl; }
...
const Eigen::RowVector3d &MillerIndex::error() const { return _error; }
...
int MillerIndex::h() const {return _hkl[0];}

int MillerIndex::k() const {return _hkl[1];}

int MillerIndex::l() const {return _hkl[2];}
