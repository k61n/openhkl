...
PeakList PeakFilter::mergedPeaksSignificance(const PeakList &peaks,
...
PeakList PeakFilter::sparseDataSet(const PeakList &peaks,
                                   size_t min_num_peaks) {
...
PeakList PeakFilter::complementary(const PeakList &peaks,
                                   const PeakList &other_peaks) const {
  PeakList filtered_peaks;
...
PeakList PeakFilter::indexed(const PeakList &peaks, const UnitCell &cell,
...
PeakList PeakFilter::unitCell(const PeakList &peaks,
                              sptrUnitCell unit_cell) const {
  PeakList filtered_peaks;
...
PeakList PeakFilter::strength(const PeakList &peaks, double min,
                              double max) const {
  PeakList filtered_peaks;
...
PeakList PeakFilter::dRange(const PeakList &peaks, double dmin,
                            double dmax) const {
  PeakList filtered_peaks;
