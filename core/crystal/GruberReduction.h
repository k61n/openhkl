...
public:
    ...
    //! Find the conventional cell and output transformation matrix, centring type and Bravais
    //! lattice of the new cell. Return value is the condition which matched (1-44)
