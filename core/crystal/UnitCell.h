...
struct UnitCellCharacter {
  ...
  UnitCellCharacter(double g00_, double g01_, double g02_, double g11_,
                    double g12_, double g22_);
};
...
class UnitCell {
public:
  static UnitCell interpolate(const UnitCell &uc1, const UnitCell &uc2,
                              double t);
  ...
  void setParameters(double a, double b, double c, double alpha, double beta,
                     double gamma);

  //! Set reciprocal lattice parameters
  void setReciprocalParameters(double as, double bs, double cs, double alphas,
  ...
  std::vector<MillerIndex> generateReflectionsInShell(double dmin, double dmax,
                                                      double wavelength) const;

  //! Return the angle in radians between two reflections hkl1 and hkl2
  double angle(const Eigen::RowVector3d &hkl1,
  ...
  void setMetric(double g00, double g01, double g02, double g11, double g12,
                 double g22);
  ...
  UnitCell fromParameters(const Eigen::Matrix3d &U0,
