...
public:
  ...
  PeakList complementary(const PeakList &peaks,
  ...
  //! tolerance
  PeakList indexed(const PeakList &peaks, const UnitCell &cell,
  ...
  PeakList mergedPeaksSignificance(const PeakList &peaks,
