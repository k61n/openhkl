...
struct MozaicTester {
  ...
  Eigen::Vector3d buildQVector(double alpha1, double ca2, double sa2,
                               double znorm, const Eigen::Vector3d &u,
                               const Eigen::Vector3d &v,
                               const Eigen::Vector3d &w);
  void updateDetector(double alpha1, double znorm, double calpha2,
                      double salpha2, double lambda, const Eigen::Vector3d &u,
                      const Eigen::Vector3d &v, const Eigen::Vector3d &w,
                      const Eigen::Vector3d &n, double px, double py, double pz,
  ...
  Eigen::MatrixXd run1(double h, double k, double l, double px = 0.0,
