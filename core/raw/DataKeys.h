...
const std::string ds_bkgGradSigma{"BkgGradientSigma"};
    ...
    const std::string at_datasetSources{
        "sources"}; // list of sources for the DataSet, separated by ';'
    ...
    //-- Default names
    const std::string kw_experimentDefaultName{
        "DEFAULT EXPERIMENT"}; // default name for an experiment
    ...
    const std::string kw_goniometerDefaultName{
        "DEFAULT GONIOMETER"}; // default name for a goniometer
