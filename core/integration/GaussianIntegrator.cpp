...
static void residuals(Eigen::VectorXd &res, double B, double I,
                      const Eigen::Vector3d x0, const Eigen::VectorXd &a,
                      const std::vector<Eigen::Vector3d> &x,
                      const std::vector<double> &M, double *pearson) {
...
bool GaussianIntegrator::compute(sptrPeak3D peak,
...
std::vector<double>
GaussianIntegrator::profile(sptrPeak3D peak, const IntegrationRegion &region) {
