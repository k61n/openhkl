...
public:
    ...
    //! Parameter r2 should be equal to (x-x0).dot(A*(x-x0)) where A is the inverse covariance
    //! matrix of the peak. Parameter M is the total count (no background correction)
