 ...
 * i.e Blob can only increase in size.Blobs can be merged and maintain zero, first and second
 * momentum. Blob3D can be transformed into an Ellipsoid, by diagonalizing the variance tensor.
 *
 */
class Blob3D {
public:
