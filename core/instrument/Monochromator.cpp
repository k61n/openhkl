...
Monochromator::Monochromator(const Monochromator &other)
    : _name(other._name), _wavelength(other._wavelength), _fwhm(other._fwhm),
...
Monochromator::Monochromator(const YAML::Node &node) {
  ...
  _fwhm = fwhmNode["value"].as<double>() *
          um->get(fwhmNode["units"].as<std::string>()) / nsx::ang;
}
...
const std::string &Monochromator::name() const { return _name; }

void Monochromator::setName(const std::string &name) { _name = name; }

double Monochromator::wavelength() const { return _wavelength; }

void Monochromator::setWavelength(double wavelength) {
  _wavelength = wavelength;
}

double Monochromator::fullWidthHalfMaximum() const { return _fwhm; }

void Monochromator::setFullWidthHalfMaximum(double fwhm) { _fwhm = fwhm; }

double Monochromator::width() const { return _width; }

void Monochromator::setWidth(double width) { _width = width; }

double Monochromator::height() const { return _height; }

void Monochromator::setHeight(double height) { _height = height; }
