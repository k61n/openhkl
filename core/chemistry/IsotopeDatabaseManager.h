...
class IsotopeDatabaseManager
    : public Singleton<IsotopeDatabaseManager, Constructor, Destructor> {
...
public:
  ...
  bool hasProperty(const std::string &isotope,
...
template <typename T>
T IsotopeDatabaseManager::property(const std::string &isotope,
                                   const std::string &property) const {
