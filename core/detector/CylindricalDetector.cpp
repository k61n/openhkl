...
CylindricalDetector::CylindricalDetector(const std::string &name)
    : Detector(name) {}

CylindricalDetector::CylindricalDetector(const YAML::Node &node)
    : Detector(node) {
...
DetectorEvent
CylindricalDetector::constructEvent(const DirectVector &from,
                                    const ReciprocalVector &kf) const {
