...
autoindex_test(expt, "n_solutions", 5, 20, 1, int, args.length_tol, args.angle_tol)
autoindex_test(expt, "n_vertices", 100, 2500, 100, int, args.length_tol, args.angle_tol)
