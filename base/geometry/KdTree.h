...
//
//! @file      base/geometry/KdTree.h
//! @brief     Defines class KdTree
//!
...
#ifndef OHKL_BASE_GEOMETRY_KDTREE_H
#define OHKL_BASE_GEOMETRY_KDTREE_H

#include <algorithm>

namespace ohkl {

// The following is taken from the C++ implementation of the K-d tree algorithm
// at Rosetta code (https://rosettacode.org/wiki/K-d_tree)
...
#endif // OHKL_BASE_GEOMETRY_KDTREE_H
