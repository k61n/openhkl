...
BOOST_AUTO_TEST_CASE(Test_Flat_Detector)
{
	...
	double th2=d.get2Theta(15.5,15.5,Eigen::Vector3d(0,1.0,0.0));
	...
	center=d.getEventPosition(15.5,15.5);
	...
	th2=d.get2Theta(15.5,15.5,Eigen::Vector3d(0,1,0));
	...
	Eigen::Vector3d kf=d.getKf(15.5,15.5,2.0);
	...
	Eigen::Vector3d Q=d.getQ(15.5,15.5,2.0);
