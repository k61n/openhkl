...
BOOST_AUTO_TEST_CASE(Test_Cylindrical_Detector)
{
	...
	double th2=d.get2Theta(319.5,127.5,Eigen::Vector3d(0,1.0,0.0));
	...
	g->setCurrentValues({90.0*deg});
	center=d.getEventPosition(319.5,127.5);
	...
	th2=d.get2Theta(319.5,127.5,Eigen::Vector3d(0,1,0));
	...
	Eigen::Vector3d kf=d.getKf(319.5,127.5,2.0);
	...
	Eigen::Vector3d Q=d.getQ(319.5,127.5,2.0);
