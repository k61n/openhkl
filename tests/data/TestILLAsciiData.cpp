...
int UnitTest_DataSet::run() {
  ...
  NSX_CHECK_CLOSE(detectorStates[3][0], 0.54347000E+05 / 1000.0 * nsx::deg,
                  tolerance);
  NSX_CHECK_CLOSE(sampleStates[2][0], 0.26572000E+05 / 1000.0 * nsx::deg,
                  tolerance);
...
int main() { nsx::UnitTest_DataSet::run(); }
