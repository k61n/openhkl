...
BOOST_AUTO_TEST_CASE(Test_ILL_Data)
{
	...
	BOOST_CHECK_CLOSE(detectorStates[3].getValues()[0],0.54347000E+05/1000*SX::Units::deg,tolerance);
	BOOST_CHECK_CLOSE(sampleStates[2].getValues()[0],0.26572000E+05/1000*SX::Units::deg,tolerance);
