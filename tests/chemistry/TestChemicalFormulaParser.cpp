...
BOOST_AUTO_TEST_CASE(Test_ChemicalFormula_Parser)
{
    ...
    material = "H[1]";
    BOOST_CHECK_NO_THROW(phrase_parse(material.begin(),material.end(),parser,blank,isotopes));
    ...
    isotopes.clear();
    material = "X";
    BOOST_CHECK_THROW(phrase_parse(material.begin(),material.end(),parser,blank,isotopes),std::runtime_error);
