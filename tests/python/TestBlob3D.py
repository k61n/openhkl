...
class TestBlob3D(unittest.TestCase):
    ...
    # assertAlmostEqual(tot,blob.getMass())
    ...
    #assertAlmostEqual(center(0),c_x)
    #assertAlmostEqual(center(1),c_y)
    #assertAlmostEqual(center(2),c_z)

    # todo: check if the semi_axes are ok AND same issue of assertAlm...
    #assertAlmostEqual(eigVal(0),sqrt(sx2))
    #assertAlmostEqual(eigVal(1),sqrt(sy2))
    #assertAlmostEqual(eigVal(2),sqrt(sz2))
    
    # todo: check the eigenvectors AND same issue of assertAlm...
    #assertAlmostEqual(((eigVec.col(0))(0)),1.0)
    #assertAlmostEqual(((eigVec.col(1))(1)),1.0)
    #assertAlmostEqual(((eigVec.col(2))(2)),1.0)
