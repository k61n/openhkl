...
BOOST_AUTO_TEST_CASE(Test_MatrixParser)
{
    ...
    TopLeftColMajorMatrixParser tlcmParser;
    tlcmParser(s,m);
    ...
    TopLeftRowMajorMatrixParser tlrmParser;
    tlrmParser(s,m);
    ...
    TopRightColMajorMatrixParser trcmParser;
    trcmParser(s,m);
    ...
    TopRightRowMajorMatrixParser trrmParser;
    trrmParser(s,m);
    ...
    BottomLeftColMajorMatrixParser blcmParser;
    blcmParser(s,m);
    ...
    BottomLeftRowMajorMatrixParser blrmParser;
    blrmParser(s,m);
    ...
    BottomRightColMajorMatrixParser brcmParser;
    brcmParser(s,m);
    ...
    BottomRightRowMajorMatrixParser brrmParser;
    brrmParser(s,m);
