...
int main() {
    ...
    NSX_TEST_CHECK_ASSERT(false);
    if (all_tests.nSuccesses() != 1 || all_tests.nFailures() != 1 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
    ...
    if (all_tests.nSuccesses() != 2 || all_tests.nFailures() != 1 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
    ...
    if (all_tests.nSuccesses() != 3 || all_tests.nFailures() != 2 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_NOT_EQUAL(1,2);
    if (all_tests.nSuccesses() != 4 || all_tests.nFailures() != 2 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
    ...
    if (all_tests.nSuccesses() != 5 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_NOT_CLOSE(1.0f,1.3f,0.2f);
    if (all_tests.nSuccesses() != 6 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_NOT_CLOSE(1.0,2.0,0.1);
    if (all_tests.nSuccesses() != 7 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
    ...
    if (all_tests.nSuccesses() != 8 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_EXCEPTION(throw MyException(),MyException);
    if (all_tests.nSuccesses() != 9 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_EXCEPTION(throw MyException(),std::exception);
    if (all_tests.nSuccesses() != 10 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }

    NSX_TEST_CHECK_ANY_EXCEPTION(throw MyException());
    if (all_tests.nSuccesses() != 11 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
    ...
    if (all_tests.nSuccesses() != 12 || all_tests.nFailures() != 3 || all_tests.nTests() != ++n_tests) {
        std::cout<<"Error when performing nsx unit test framework"<<std::endl;
        return 1;
    }
