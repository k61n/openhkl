...
if (LSB_CMD)
    ...
    execute_process(COMMAND ${LSB_CMD} -i OUTPUT_VARIABLE UNIX_DIST OUTPUT_STRIP_TRAILING_WHITESPACE)
    ...
    # get the codename
    execute_process(COMMAND ${LSB_CMD} -c OUTPUT_VARIABLE UNIX_CODENAME OUTPUT_STRIP_TRAILING_WHITESPACE)
    string(REGEX REPLACE "Codename:" "" UNIX_CODENAME ${UNIX_CODENAME})
    string(STRIP ${UNIX_CODENAME} UNIX_CODENAME)

    # Make Carbon and Final look like Santiago
    string(REGEX REPLACE "Carbon" "Santiago" UNIX_DIST ${UNIX_DIST})
    string(REGEX REPLACE "Final" "Santiago" UNIX_DIST ${UNIX_DIST})

    # get the release
    execute_process(COMMAND ${LSB_CMD} -r OUTPUT_VARIABLE UNIX_RELEASE OUTPUT_STRIP_TRAILING_WHITESPACE)
