...
class Settings(wx.ScrolledWindow):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self._minSize = intctrl.IntCtrl(self, wx.ID_ANY, style=wx.TE_PROCESS_ENTER, value=5, min=1, limited=True)
        maxSizeText = wx.StaticText(self, wx.ID_ANY, label="Max. size")
        self._maxSize = intctrl.IntCtrl(self, wx.ID_ANY, style=wx.TE_PROCESS_ENTER, value=100000, min=1, limited=True)
        ciText = wx.StaticText(self, wx.ID_ANY, label="Confidence Interval")
        self._ciValue = wx.TextCtrl(self, wx.ID_ANY, style=wx.TE_PROCESS_ENTER, value="0.995")
