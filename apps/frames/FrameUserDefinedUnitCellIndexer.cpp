...
FrameUserDefinedUnitCellIndexer *FrameUserDefinedUnitCellIndexer::_instance =
    nullptr;

FrameUserDefinedUnitCellIndexer *
FrameUserDefinedUnitCellIndexer::create(ExperimentItem *experiment_item,
...
FrameUserDefinedUnitCellIndexer::FrameUserDefinedUnitCellIndexer(
    ...
    : NSXQFrame(), _ui(new Ui::FrameUserDefinedUnitCellIndexer),
      _experiment_item(experiment_item), _indexer() {
  _ui->setupUi(this);
  ...
  _ui->label_alpha->setText(QString(QChar(0x03B1)) + "(" +
                            QString(QChar(0x00B0)) + ")");
  _ui->label_beta->setText(QString(QChar(0x03B2)) + "(" +
                           QString(QChar(0x00B0)) + ")");
  _ui->label_gamma->setText(QString(QChar(0x03B3)) + "(" +
                            QString(QChar(0x00B0)) + ")");
  ...
  connect(_ui->unit_cells->verticalHeader(), SIGNAL(sectionDoubleClicked(int)),
          this, SLOT(slotSelectSolution(int)));
...
void FrameUserDefinedUnitCellIndexer::slotActionClicked(
