...
FrameDetectorGlobalOffsets::create(ExperimentItem *experiment_item) {
  if (!_instance) {
...
FrameDetectorGlobalOffsets::FrameDetectorGlobalOffsets(
    ...
    : NSXQFrame(), _ui(new Ui::FrameDetectorGlobalOffsets),
...
void FrameDetectorGlobalOffsets::fit() {
  ...
  const auto *detector =
      _experiment_item->experiment()->diffractometer()->detector();
