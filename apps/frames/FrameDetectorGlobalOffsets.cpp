...
//
//! @file      apps/frames/FrameDetectorGlobalOffsets.cpp
//! @brief     Implements class FrameDetectorGlobalOffsets
//!
//! @homepage  ###HOMEPAGE###
...
void FrameDetectorGlobalOffsets::fit()
{
    ...
    auto fit_results = fitDetectorGonioOffsets(
        detector->gonio(), selected_data, _ui->n_iterations->value(), _ui->tolerance->value());
