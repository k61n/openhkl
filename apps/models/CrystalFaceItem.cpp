...
CrystalFaceItem::CrystalFaceItem(QGraphicsItem *parent)
    : QGraphicsItem(parent) {
  _points = new QPointF[3];
}

void CrystalFaceItem::set(const Eigen::Vector3d &p1, const Eigen::Vector3d &p2,
...
void CrystalFaceItem::paint(QPainter *painter,
