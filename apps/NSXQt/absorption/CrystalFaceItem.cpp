...
void CrystalFaceItem::set(const Eigen::Vector3d &p1, const Eigen::Vector3d &p2, const Eigen::Vector3d &p3)
{
    _points->setX(p1[0]);
    _points++;
    _points->setX(p2[0]);
...
void CrystalFaceItem::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    Q_UNUSED(option);
    Q_UNUSED(widget);
