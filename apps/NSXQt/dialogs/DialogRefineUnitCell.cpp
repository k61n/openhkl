...
DialogRefineUnitCell::DialogRefineUnitCell(std::shared_ptr<SX::Instrument::Experiment> experiment, sptrUnitCell unitCell, const std::vector<sptrPeak3D>& peaks, QWidget *parent)
: QDialog(parent),
