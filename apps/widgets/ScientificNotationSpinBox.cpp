...
int ScientificNotationSpinBox::decimals() const { return dispDecimals; }

void ScientificNotationSpinBox::setDecimals(int value) { dispDecimals = value; }
...
void ScientificNotationSpinBox::stepDown() { setValue(value() / 10.0); }

void ScientificNotationSpinBox::stepUp() { setValue(value() * 10.0); }
...
// overwritten virtual function of QAbstractSpinBox
QValidator::State ScientificNotationSpinBox::validate(QString &text,
                                                      int &pos) const {
