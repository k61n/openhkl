...
WidgetRefinerFit::WidgetRefinerFit(
    const std::map<nsx::sptrDataSet, nsx::Refiner> &refiners)
  ...
  connect(_ui->selected_data, SIGNAL(currentRowChanged(int)), this,
          SLOT(slotSelectedDataChanged(int)));

  connect(_ui->selected_batch, SIGNAL(valueChanged(int)), this,
          SLOT(slotSelectedBatchChanged(int)));
...
WidgetRefinerFit::~WidgetRefinerFit() { delete _ui; }
...
void WidgetRefinerFit::slotSelectedBatchChanged(int selected_batch) {
  ...
  _ui->plot->setInteractions(QCP::iRangeDrag | QCP::iRangeZoom |
...
void WidgetRefinerFit::slotSelectedFrameChanged(int selected_frame) {
  ...
  _ui->detector_orientation_00->setValue(
      selected_state.detectorOrientation(0, 0));
  _ui->detector_orientation_01->setValue(
      selected_state.detectorOrientation(0, 1));
  _ui->detector_orientation_02->setValue(
      selected_state.detectorOrientation(0, 2));
  _ui->detector_orientation_10->setValue(
      selected_state.detectorOrientation(1, 0));
  _ui->detector_orientation_11->setValue(
      selected_state.detectorOrientation(1, 1));
  _ui->detector_orientation_12->setValue(
      selected_state.detectorOrientation(1, 2));
  _ui->detector_orientation_20->setValue(
      selected_state.detectorOrientation(2, 0));
  _ui->detector_orientation_21->setValue(
      selected_state.detectorOrientation(2, 1));
  _ui->detector_orientation_22->setValue(
