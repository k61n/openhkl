...
WidgetUnitCell::WidgetUnitCell(nsx::sptrUnitCell unit_cell)
  ...
  _ui->bravais->setText(
      QString::fromStdString(_unit_cell->bravaisTypeSymbol()));
...
WidgetUnitCell::~WidgetUnitCell() { delete _ui; }

nsx::sptrUnitCell WidgetUnitCell::unitCell() const { return _unit_cell; }
