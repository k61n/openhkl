...
void CutLineGraphicsItem::paint(QPainter *painter,
...
int CutLineGraphicsItem::getNPoints() const { return _nPoints; }

void CutLineGraphicsItem::setNPoints(int nPoints) { _nPoints = nPoints; }
...
std::string CutLineGraphicsItem::getPlotType() const { return "simple"; }
