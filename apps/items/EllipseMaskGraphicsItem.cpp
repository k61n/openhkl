...
EllipseMaskGraphicsItem::EllipseMaskGraphicsItem(nsx::sptrDataSet data,
                                                 nsx::AABB *aabb)
    : SXGraphicsItem(nullptr, true, true), _data(data), _aabb(aabb),
      _from(0, 0), _to(0, 0) {
  _pen.setWidth(1);
...
void EllipseMaskGraphicsItem::paint(QPainter *painter,
...
nsx::AABB *EllipseMaskGraphicsItem::getAABB() { return _aabb; }
