...
DetectorScene *DetectorGraphicsView::getScene() { return _scene; }
...
void DetectorGraphicsView::fitScene() { fitInView(_scene->sceneRect()); }

void DetectorGraphicsView::fixDetectorAspectRatio(bool value) {
  const auto *detector =
      _scene->getData()->reader()->diffractometer()->detector();
