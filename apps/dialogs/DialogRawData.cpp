...
DialogRawData::DialogRawData(QWidget *parent)
    : QDialog(parent), ui(new Ui::DialogRawData) {
  ui->setupUi(this);
}

DialogRawData::~DialogRawData() { delete ui; }

double DialogRawData::wavelength() { return ui->wavelength->value(); }

double DialogRawData::deltaChi() { return ui->deltaChi->value(); }

double DialogRawData::deltaOmega() { return ui->deltaOmega->value(); }

double DialogRawData::deltaPhi() { return ui->deltaPhi->value(); }

bool DialogRawData::swapEndian() { return ui->swapEndian->isChecked(); }
