...
NumorItem::NumorItem(std::shared_ptr<nsx::Instrument::Experiment> experiment,std::shared_ptr<nsx::Data::DataSet> data) :
...
std::shared_ptr<nsx::Data::DataSet> NumorItem::getData()
{
    return _data;
}
