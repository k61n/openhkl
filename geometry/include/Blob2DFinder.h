...
namespace Geometry
{
	...
	template <typename _datatype> blob2DCollection findBlobs2D(_datatype* dataptr,unsigned int nrows,unsigned int ncols, _datatype threashold, int minComp, int maxComp, bool rowMajor=1)
	{
